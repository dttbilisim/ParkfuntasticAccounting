...
public class ProductOptionProvider : FieldDefinitionValueOptionProvider
{
    private readonly IUnitOfWork<ApplicationDbContext> _context;

    public ProductOptionProvider(IUnitOfWork<ApplicationDbContext> context)
    {
        _context = context;
    }
    ...
    {
        var query = _context.GetRepository<Product>().GetAll(true);
