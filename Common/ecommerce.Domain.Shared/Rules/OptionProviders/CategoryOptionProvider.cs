...
public class CategoryOptionProvider : FieldDefinitionValueOptionProvider
{
    private readonly IUnitOfWork<ApplicationDbContext> _context;

    public CategoryOptionProvider(IUnitOfWork<ApplicationDbContext> context)
    {
        _context = context;
    }
    ...
    {
        var query = _context.GetRepository<Category>().GetAll(true);
