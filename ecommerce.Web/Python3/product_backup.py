...
while True:
    ...
    sql = f'''
    WITH ProductFirstGroupCode AS (
        SELECT DISTINCT ON ("ProductId")
            "ProductId",
            "GroupCode",
            (string_to_array("GroupCode", '|'))[1] AS "PartNumber"
    ...
    LEFT JOIN ProductFirstGroupCode PFG ON PFG."ProductId" = P."Id"
    LEFT JOIN "DotParts" DP ON DP."PartNumber" = PFG."PartNumber"
    LEFT JOIN (
