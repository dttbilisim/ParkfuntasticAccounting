...
public class BrandOptionProvider : FieldDefinitionValueOptionProvider
{
    private readonly IUnitOfWork<ApplicationDbContext> _context;

    public BrandOptionProvider(IUnitOfWork<ApplicationDbContext> context)
    {
        _context = context;
    }
    ...
    {
        var query = _context.GetRepository<Brand>().GetAll(true);
